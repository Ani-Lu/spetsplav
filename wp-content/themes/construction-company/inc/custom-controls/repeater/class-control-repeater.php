<?php
/**
 * Construction Company Customizer Repeater Control.
 * 
...
if( ! class_exists( 'Construction_Company_Control_Repeater' ) ) {
    ...
    class Construction_Company_Control_Repeater extends WP_Customize_Control {
    	 ...
    	 * @var string
    	 */
    	public $type = 'construction-company-repeater';
    	...
    	protected function render_content() {
    		...
    		<?php if ( isset( $this->choices['limit'] ) ) : ?>
    			<p class="limit"><?php printf( esc_html__( 'Limit: %s rows', 'construction-company' ), esc_html( $this->choices['limit'] ) ); ?></p>
    		<?php endif; ?>
    					...
    					<# _.each( data, function( field, i ) { #>
    						...
    						<div class="repeater-field repeater-field-{{{ field.type }}}">
    							...
    							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
    								...
    								<figure class="construction-company-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'construction-company' ); ?>" >
    									<# if ( field.default ) { #>
    							...
    							<# } else if ( field.type === 'upload' ) { #>
    								...
    								<figure class="construction-company-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'construction-company' ); ?>" >
    									<# if ( field.default ) { #>
